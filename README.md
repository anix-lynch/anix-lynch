...
> Drafts curated here while repos are WIP. Links will be added as soon as each project is pushed.

### 🗺️ Kalasin Map — Geo Intelligence Pack (Investor-ready)

Land sale "intel packet" for Kalasin using Google Maps Platform. ASCII metro-style maps, POI distance, and broker distribution workflow (FB/LINE). Outcome: faster trust and decisions without a deed yet.

- **Tech Stack:** Google Maps API • Static Maps • Routes • Python • Canva layout • Notion playbook
- **Highlights:** Landmark-first narrative, corridor lines (213/227/12), future airport lens

### 🥤 Smoothieverse — SQL→dbt→Streamlit (Free-tier Cloud)

End-to-end data engineering portfolio: synthetic franchise dataset → dbt models → Streamlit dashboard. Proves modern SQL, modeling, and BI delivery on free tiers.

- **Tech Stack:** SQLite/DuckDB • dbt-core • Python (Pandas) • Streamlit • AWS/GCP free tiers
- **Highlights:** Clean star schema, SUCKDA roadmap, ATS-ready bullets

### 🎵 Father Figure — Audio DNA Analyzer (HF)

One-song deep dive into "floatiness" DNA. Dataset → feature extraction → HF Space UI → API plan for inference.

- **Tech Stack:** Hugging Face (Spaces, embeddings) • Python • librosa • Streamlit/Gradio (UI)
- **Highlights:** Producer-friendly "DNA" report, terminology bridge for recruiters

### 🤖 Streamlit Autodeploy Agent — 7-Step Benchmark

Agentic pipeline that creates files, installs, runs, debugs, dockerizes, and deploys a Streamlit app (AWS/GCP).

- **Tech Stack:** AgentKit/Codex CLI (eval) • Streamlit • Docker • AWS/GCP deploy scripts
- **Highlights:** Clear 7-step E2E rubric to separate code generators from real agents
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/anixlynch)
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=github&logoColor=white)](https://anixlynch.github.io)
[![HuggingFace](https://img.shields.io/badge/%F0%9F%A4%97Hugging%20Face-FFD21E?style=for-the-badge&logoColor=black)](https://huggingface.co/anixlynch)
[![Kaggle](https://img.shields.io/badge/Kaggle-20BEFF?style=for-the-badge&logo=kaggle&logoColor=white)](https://kaggle.com/anixlynch)
